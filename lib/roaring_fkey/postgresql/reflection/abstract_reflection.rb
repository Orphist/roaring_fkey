    ...
    module Reflection
      module AbstractReflection
        ...
        def build_id_constraint(klass_attr, source_attr)
          ...
          if source_attr.is_a?(AREL_ATTR) && source_attr.type_caster.type.eql?(:roaringbitmap)
            ...
            klass_attr = ::Arel::Nodes.build_quoted(klass_attr.cast(:int))
            ids_not_empty = ::Arel::Nodes::NamedFunction.new('rb_is_empty', [source_attr]).not
